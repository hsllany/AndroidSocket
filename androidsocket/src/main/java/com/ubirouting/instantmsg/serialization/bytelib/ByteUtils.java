package com.ubirouting.instantmsg.serialization.bytelib;
...
public final class ByteUtils {
    ...
    static Comparator<Field> sComparator = new Comparator<Field>() {
        @Override
        public int compare(Field lhs, Field rhs) {
            ToByte annotation = lhs.getAnnotation(ToByte.class);
            ToByte annotation2 = rhs.getAnnotation(ToByte.class);
    ...
    private static void encodeList(String typeStr, Field field, Object comm, List<byte[]> listBytes) {
        try {
            if (typeStr.contains("<java.lang.String>")) {
                ...
                byte[] longBytes = new byte[length * 8];
                ...
                byte[] intBytes = new byte[length * 4];
                ...
                byte[] shortBytes = new byte[length * 2];
                ...
                byte[] doubleBytes = new byte[length * 8];
